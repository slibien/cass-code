...
> [!IMPORTANT]
> This is the documentation for the _legacy_ TypeScript implementation of the Codex CLI. It has been superseded by the _Rust_ implementation. See the [README in the root of the Codex repository](https://github.com/slibien/cass-code/blob/main/README.md) for details.
...
- **macOS 12+** - commands are wrapped with **Apple Seatbelt** (`sandbox-exec`).
  ...
  - Everything is placed in a read-only jail except for a small set of
    writable roots (`$PWD`, `$TMPDIR`, `~/.cass`, etc.).
...
Below are a few bite-size examples you can copy-paste. Replace the text in quotes with your own task. See the [prompting guide](https://github.com/slibien/cass-code/blob/main/codex-cli/examples/prompting_guide.md) for more tips and usage patterns.
...
git clone https://github.com/slibien/cass-code.git
cd codex/codex-cli
...
Codex configuration files can be placed in the `~/.cass/` directory, supporting both YAML and JSON formats.
...
1. YAML format (save as `~/.cass/config.yaml`):
...
2. JSON format (save as `~/.cass/config.json`):
...
You can create a `~/.cass/AGENTS.md` file to define custom guidance for the agent:
