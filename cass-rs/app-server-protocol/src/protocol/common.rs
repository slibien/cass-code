...
use cass_protocol::protocol::SandboxCommandAssessment;
use paste::paste;
...
client_request_definitions! {
    ...
    /// List recorded Cass conversations (rollouts) with optional pagination and search.
    ListConversations {
        params: v1::ListConversationsParams,
        response: v1::ListConversationsResponse,
    },
    /// Resume a recorded Cass conversation from a rollout file.
    ResumeConversation {
...
pub struct ApplyPatchApprovalParams {
    ...
    /// Use to correlate this with [cass_core::protocol::PatchApplyBeginEvent]
    /// and [cass_core::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ConversationId,
    /// Use to correlate this with [cass_core::protocol::ExecCommandBeginEvent]
    /// and [cass_core::protocol::ExecCommandEndEvent].
    pub call_id: String,
...
/// Superset of [`cass_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
