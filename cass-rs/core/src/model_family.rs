...
const GPT_5_CODEX_INSTRUCTIONS: &str = include_str!("../gpt_5_cass_prompt.md");
...
pub fn find_family_for_model(slug: &str) -> Option<ModelFamily> {
    ...
    } else if slug.starts_with("cass-mini-latest") {
        model_family!(
    ...
    // Internal models.
    } else if slug.starts_with("cass-exp-") {
        model_family!(
            slug, slug,
            supports_reasoning_summaries: true,
            reasoning_summary_format: ReasoningSummaryFormat::Experimental,
    ...
    // Production models.
    } else if slug.starts_with("gpt-5-codex") || slug.starts_with("cass-") {
        model_family!(
            slug, slug,
            supports_reasoning_summaries: true,
            reasoning_summary_format: ReasoningSummaryFormat::Experimental,
