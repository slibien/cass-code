...
//!
//! The [`McpConnectionManager`] owns one [`cass_rmcp_client::RmcpClient`] per
...
use cass_rmcp_client::RmcpClient;
            ...
            join_set.spawn(async move {
                ...
                let params = mcp_types::InitializeRequestParams {
                    ...
                    client_info: Implementation {
                        name: "cass-mcp-client".to_owned(),
                        version: env!("CARGO_PKG_VERSION").to_owned(),
                        title: Some("Cass".into()),
                        // This field is used by Cass when it is an MCP
                        // server: it should not be used when Cass is
                        // an MCP client.
                        user_agent: None,
                    },
