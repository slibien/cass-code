use cass_protocol::items::AgentMessageContent;
use cass_protocol::items::AgentMessageItem;
use cass_protocol::items::ReasoningItem;
use cass_protocol::items::TurnItem;
use cass_protocol::items::UserMessageItem;
use cass_protocol::items::WebSearchItem;
    ...
    fn parses_agent_message() {
        let item = ResponseItem::Message {
            ...
            content: vec![ContentItem::OutputText {
                text: "Hello from Cass".to_string(),
            }],
        };
        ...
        match turn_item {
            TurnItem::AgentMessage(message) => {
                ...
                assert_eq!(text, "Hello from Cass");
            }
