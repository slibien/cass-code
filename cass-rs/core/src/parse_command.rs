...
/// The easiest way to iterate is to add unit tests and have Cass fix the implementation.
...
/// Tests are at the top to encourage using TDD + Cass to fix the implementation.
mod tests {
    use super::*;
    use std::path::PathBuf;
