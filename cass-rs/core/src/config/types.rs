...
pub struct McpServerConfig {
    ...
    /// When `false`, Cass skips initializing this MCP server.
...
/// (primarily the Cass IDE extension). NOTE: these are different from
...
impl From<SandboxWorkspaceWrite> for cass_app_server_protocol::SandboxSettings {
