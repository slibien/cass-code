...
async fn fork_conversation_twice_drops_to_first_message() {
    ...
    // Configure Cass to use the mock server.
    ...
    let fork1_path = cass_fork1.rollout_path();
    ...
    let fork2_path = cass_fork2.rollout_path();
