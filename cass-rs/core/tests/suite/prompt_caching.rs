...
use cass_core::shell::Shell;
use cass_core::shell::default_user_shell;
...
async fn cass_mini_latest_tools() {
    skip_if_no_network!();
    ...
    config.model = "cass-mini-latest".to_string();
    config.model_family = find_family_for_model("cass-mini-latest").unwrap();
