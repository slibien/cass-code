...
use cass_core::auth::read_openai_api_key_from_env;
use cass_login::ServerOptions;
...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use Cass as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Cass".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                "\u{1b}]8;;https://github.com/slibien/cass-code\u{7}Cass docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
            "  Cass can make mistakes".into(),
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Cass will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let cass_home_path = cass_home.path().to_path_buf();
        let widget = AuthModeWidget {
            request_frame: FrameRequester::test_dummy(),
            highlighted_mode: AuthMode::ChatGPT,
            error: None,
            sign_in_state: Arc::new(RwLock::new(SignInState::PickMode)),
            cass_home: cass_home_path.clone(),
