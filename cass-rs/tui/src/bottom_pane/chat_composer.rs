...
use cass_protocol::custom_prompts::PROMPTS_CMD_PREFIX;
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            sender,
            false,
            "Ask Cass to do anything".to_string(),
            false,
        );
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("cass_tui_test_paste_image.png");
        ...
        assert!(
            composer
                .textarea
                .text()
                .starts_with("[cass_tui_test_paste_image.png 3x2] ")
        );
