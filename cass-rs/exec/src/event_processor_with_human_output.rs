use cass_common::elapsed::format_duration;
use cass_common::elapsed::format_elapsed;
...
use cass_protocol::num_format::format_with_separators;
...
use crate::event_processor::CassStatus;
use crate::event_processor::EventProcessor;
use crate::event_processor::handle_last_message;
use cass_common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<cass_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(
            self,
            "OpenAI Cass v{} (research preview)\n--------",
            VERSION
        );
    ...
    fn process_event(&mut self, event: Event) -> CassStatus {
        ...
        match msg {
            ...
            EventMsg::TaskComplete(TaskCompleteEvent { last_agent_message }) => {
                ...
                return CassStatus::InitiateShutdown;
            }
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "cass".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "cass session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return CassStatus::Shutdown,
