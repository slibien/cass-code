...
use cass_core::protocol::McpInvocation;
...
use cass_core::protocol::SessionConfiguredEvent;
use cass_core::protocol::WarningEvent;
use cass_core::protocol::WebSearchEndEvent;
use cass_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use cass_exec::exec_events::AgentMessageItem;
use cass_exec::exec_events::CommandExecutionItem;
use cass_exec::exec_events::CommandExecutionStatus;
use cass_exec::exec_events::ErrorItem;
use cass_exec::exec_events::ItemCompletedEvent;
use cass_exec::exec_events::ItemStartedEvent;
use cass_exec::exec_events::ItemUpdatedEvent;
use cass_exec::exec_events::McpToolCallItem;
use cass_exec::exec_events::McpToolCallItemError;
use cass_exec::exec_events::McpToolCallItemResult;
use cass_exec::exec_events::McpToolCallStatus;
use cass_exec::exec_events::PatchApplyStatus;
use cass_exec::exec_events::PatchChangeKind;
use cass_exec::exec_events::ReasoningItem;
use cass_exec::exec_events::ThreadErrorEvent;
use cass_exec::exec_events::ThreadEvent;
use cass_exec::exec_events::ThreadItem;
use cass_exec::exec_events::ThreadItemDetails;
use cass_exec::exec_events::ThreadStartedEvent;
use cass_exec::exec_events::TodoItem as ExecTodoItem;
use cass_exec::exec_events::TodoListItem as ExecTodoListItem;
use cass_exec::exec_events::TurnCompletedEvent;
use cass_exec::exec_events::TurnFailedEvent;
use cass_exec::exec_events::TurnStartedEvent;
use cass_exec::exec_events::Usage;
use cass_exec::exec_events::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        cass_protocol::ConversationId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8")
            .unwrap();
    ...
    let ev = event(
        ...
        EventMsg::SessionConfigured(SessionConfiguredEvent {
            session_id,
            model: "cass-mini-latest".to_string(),
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TaskStarted(cass_core::protocol::TaskStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TaskComplete(cass_core::protocol::TaskCompleteEvent {
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(cass_core::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(cass_core::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = cass_core::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = cass_core::protocol::TokenUsageInfo {
    ...
    let token_count_event = event(
        "e1",
        EventMsg::TokenCount(cass_core::protocol::TokenCountEvent {
            info: Some(info),
            rate_limits: None,
        }),
    );
