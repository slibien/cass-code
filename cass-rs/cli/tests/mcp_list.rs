...
fn cass_command(cass_home: &Path) -> Result<assert_cmd::Command> {
...
fn list_shows_empty_state() -> Result<()> {
    ...
    let mut cmd = cass_command(cass_home.path())?;
...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = cass_command(cass_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(cass_home.path()).await?;
    ...
    let mut list_cmd = cass_command(cass_home.path())?;
    ...
    let mut list_json_cmd = cass_command(cass_home.path())?;
    ...
    let mut get_cmd = cass_command(cass_home.path())?;
    ...
    let mut get_json_cmd = cass_command(cass_home.path())?;
    get_json_cmd
