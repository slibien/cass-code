...
pub async fn run_login_status(cli_config_overrides: CliConfigOverrides) -> ! {
    ...
    match CassAuth::from_auth_storage(&config.cass_home, config.cli_auth_credentials_store_mode) {
...
pub async fn run_logout(cli_config_overrides: CliConfigOverrides) -> ! {
    ...
    match logout(&config.cass_home, config.cli_auth_credentials_store_mode) {
        Ok(true) => {
