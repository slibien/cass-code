...
#[derive(Clone)]
pub struct CassFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for CassFeedback {
    fn default() -> Self {
        Self::new()
    }
}
...
impl CassFeedback {
    ...
    pub fn snapshot(&self, session_id: Option<ConversationId>) -> CassLogSnapshot {
        let bytes = {
...
pub struct CassLogSnapshot {
    bytes: Vec<u8>,
    pub thread_id: String,
}

impl CassLogSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("cass-feedback-{}.log", self.thread_id);
    ...
    pub fn upload_feedback(
        ...
        if include_logs {
            envelope.add_item(EnvelopeItem::Attachment(Attachment {
                ...
                filename: String::from("cass-logs.log"),
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = CassFeedback::with_capacity(8);
        {
