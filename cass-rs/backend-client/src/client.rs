...
impl Client {
    ...
    pub async fn from_auth(base_url: impl Into<String>, auth: &CassAuth) -> Result<Self> {
        let token = auth.get_token().await.map_err(anyhow::Error::from)?;
        let mut client = Self::new(base_url)?
            .with_user_agent(get_cass_user_agent())
    ...
    fn headers(&self) -> HeaderMap {
        ...
        if let Some(ua) = &self.user_agent {
            ...
            h.insert(USER_AGENT, HeaderValue::from_static("cass-cli"));
        }
    ...
    pub async fn get_rate_limits(&self) -> Result<RateLimitSnapshot> {
        let url = match self.path_style {
            PathStyle::CassApi => format!("{}/api/codex/usage", self.base_url),
    ...
    pub async fn list_tasks(
        ...
        let url = match self.path_style {
            PathStyle::CassApi => format!("{}/api/codex/tasks/list", self.base_url),
    ...
    pub async fn get_task_details_with_body(
        ...
        let url = match self.path_style {
            PathStyle::CassApi => format!("{}/api/codex/tasks/{}", self.base_url, task_id),
    ...
    pub async fn create_task(&self, request_body: serde_json::Value) -> Result<String> {
        let url = match self.path_style {
            PathStyle::CassApi => format!("{}/api/codex/tasks", self.base_url),
